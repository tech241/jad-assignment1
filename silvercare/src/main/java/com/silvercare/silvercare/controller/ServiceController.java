...
//	@PostMapping
	@CrossOrigin
	@RequestMapping(method=RequestMethod.GET, path="/package", consumes="application/json")
	public ArrayList<Map<String, Object>> getAllPackages() throws StripeException {
		try {
			return new ServiceModel().getServicePackages();
	...
	public ArrayList<Map<String, Object>> getAllCaretakers() throws StripeException {
		try {
			return new ServiceModel().getServiceCaretakers();
		} catch (SQLException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
