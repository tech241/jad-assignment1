...
public class StripeConfirmPaymentServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (sessionId == null || sessionId.isBlank()) {
            response.sendRedirect(request.getContextPath() + "/public/paymentSuccess.jsp?errMsg=Missing Stripe session id.");
            return;
        }
        ...
        try {
            ...
            boolean paid = resBody.contains("\"paymentStatus\":\"paid\"");
            boolean updated = !resBody.contains("\"updatedBookings\":0");
            ...
            e.printStackTrace();
            response.sendRedirect(request.getContextPath() + "/public/paymentSuccess.jsp?errMsg=Error confirming payment.");
        }
    }
